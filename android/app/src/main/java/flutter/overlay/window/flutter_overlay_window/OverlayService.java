...
// Parche local (flutter_overlay_window 0.5.0): reemplaza la clase del plugin en el APK.
// - onStartCommand: intent null → START_NOT_STICKY (evita NPE al reiniciar el servicio)
// - onCreate: startForeground en try/catch (ForegroundServiceStartNotAllowedException)
// - START_NOT_STICKY en lugar de START_STICKY para no reactivar el servicio en frío
...
public class OverlayService extends Service implements View.OnTouchListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        // Android puede reiniciar el servicio sticky con intent null (issue #177).
        if (intent == null) {
            Log.w("OverlayService", "onStartCommand con intent null; deteniendo servicio");
            stopSelf();
    ...
    public void onCreate() {
        ...
        try {
            ...
            Log.e("OverlayService", "startForeground bloqueado (app idle)", e);
            stopSelf();
            return;
        }
        instance = this;
